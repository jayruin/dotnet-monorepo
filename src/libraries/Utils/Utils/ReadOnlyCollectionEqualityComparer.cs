...
public sealed class ReadOnlyCollectionEqualityComparer<TCollection, TItem> : IEqualityComparer<TCollection>
    where TCollection : IReadOnlyCollection<TItem>
{
    private readonly IEqualityComparer<TItem> _itemComparer;

    public ReadOnlyCollectionEqualityComparer(IEqualityComparer<TItem>? itemComparer = null)
    {
